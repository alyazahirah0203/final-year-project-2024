...
if($query -> rowCount() == 0)
{
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status,Password,id_card) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status,:password,:id_card)";
...
<body>
 ...
 <div class="login px-4 mx-auto mw-100">
                            ...
                            <form action="#" method="post"  name="signup" onsubmit="return checkpass();">
								...
								<div class="form-group">
                                    <label for="id_card" class="col-form-label">Identification Card</label>
                                    <input type="text" class="form-control" name="id_card" id="id_card" placeholder="ID Card" required>
                                </div>
