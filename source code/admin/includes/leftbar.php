	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="managedonorrecord.php"><i class="fa fa-users"></i>Manage Donor Record</a></li>
			...
			<li><a href="campaigncreation.php"><i class="fa fa-files-o"></i> Manage Campaign</a></li>
