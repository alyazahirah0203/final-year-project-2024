...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->id_card);?>
...
{?>
<!--<a href="donor-list.php?hidden=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to hidden this detail')" class="btn btn-primary"> Make it Hidden</a> -->
<?php } else {?>
...
<a href="edit-donor.php?eid=<?php echo htmlentities($result->id);?>" class="btn btn-success" style="margin-top:1%;"> Edit</a>
</td>
