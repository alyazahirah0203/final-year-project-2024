...
{ ?>
                            ...
                            <div class="col-6 header-top_w3layouts pl-3 text-lg-left text-center">
                                <p class="text-white">
                                    <i class="fas fa-map-marker-alt mr-2"></i>BDMS</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-6 top-w3layouts">
                                <p class="text-white">
                                    ...
                                    <a href="mailto:info@example.com" class="text-white">bdms@gmail.com</a>
                                </p>
                            </div>
                            <div class="col-lg-5 col-6 header-w3layouts pl-4 text-lg-left">
                                <p class="text-white">
                                    <i class="fas fa-phone mr-2"></i>09-5133333</p>
                            </div>
                        </div><?php } } ?>
                    </div>
                </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light fixed-navi">
                <div class="container">
                    ...
                    <h1>
                        ...
                        <img src="images/logo.png" alt="BDMS Logo" class="img-fluid" style="max-height: 100px;">
                        </a>
                    </h1>
                    <!-- //logo -->
                        ...
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="historyrecord.php">Blood History Record</a>
                                    <div class="dropdown-divider"></div>
